...
static NSString * const selfName = @"Me";
static NSString * const dateName = @"Nonbinary Gender Monster";
static NSString * const kJSQDemoAvatarDisplayNameJobs = @"Monster Lady";
